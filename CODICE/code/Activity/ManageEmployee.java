...
public class ManageEmployee extends JFrame implements ActionListener  {
	...
	public ManageEmployee(String eid, ViewEmployeeActivity prev) {
		...
		userIdLabel = new JLabel("ID Impiegato: "+employee.getUserId());
		...
		phoneNumberLabel = new JLabel("Cellulare: ");
		...
		buttonDelete = new JButton("Elimina Impiegato");
		buttonDelete.setBounds(180, 220, Theme.BUTTON_PRIMARY_WIDTH+80,30);
